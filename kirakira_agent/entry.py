...
from kirakira_agent.bootstrap import DEFAULT_WORKSPACE, initialize_workspace, run_setup_wizard
from kirakira_agent.config import config_value, load_dotenv, load_toml_config
...
def main(argv: list[str] | None = None) -> None:
    ...
    if command != "gateway":
        from kirakira_agent.supervisor import run_supervisor
