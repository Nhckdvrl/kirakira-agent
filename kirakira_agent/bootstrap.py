...
def initialize_workspace(
    ...
    *,
    ...
    from kirakira_agent.proactive.loop import _PROACTIVE_CONTEXT_TEMPLATE
    from kirakira_agent.proactive.sources import _INBOX_README
    from kirakira_agent.drift.skills import ensure_example_skill
