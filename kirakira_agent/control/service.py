...
from kirakira_agent.control.errors import ThreadBusyError, ThreadNotFoundError
from kirakira_agent.control.ids import new_thread_id
from kirakira_agent.control.models import ThreadRecord, ThreadSource, TurnRequest
from kirakira_agent.control.protocol.models import InitializeParams
from kirakira_agent.control.protocol.errors import JsonRpcError, UNAUTHORIZED
from kirakira_agent.control.runtime import ConversationRuntime, TurnHandle
...
class ControlService:
    ...
    def start_consolidation(self, thread_id: str) -> OperationHandle:
        ...
        from kirakira_agent.control.ids import new_operation_id
