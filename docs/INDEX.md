...
| 文档 | 状态 |
| --- | --- |
| [MEMORY2_M0_M1.md](./MEMORY2_M0_M1.md) | 历史。记忆 M0/M1 阶段的迁移与恢复过程;当前权威是 MEMORY_SYSTEM.md |

## 与 Reference 的差异

Reference 的 `docs/` 还有 `WORKFLOW.md`、`projectneed.md`、`templates/`。kirakira 目前是单人学习型项目,没有多人交付流程与稳定需求条款的实际需要,因此未建立;等出现真实协作需求时再补,不先摆空文件。写作规范沿用 `Reference/docs/writing-rules.md`。
